            ...
            <div className="space-y-10">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <a href="mailto:hello@hyperscalerowl.io" className="text-primary font-bold text-lg hover:underline">hello@hyperscalerowl.io</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <a href="https://github.com/hyperscalerowl" className="text-primary font-bold text-lg hover:underline">github.com/hyperscalerowl</a>
                </div>
              </div>
