      ...
      <AnimatedSection className="relative overflow-hidden flex items-center justify-center min-h-[80vh] bg-gray-900 text-white">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center py-20">
          ...
          <p className="text-xl md:text-3xl text-gray-200 max-w-4xl mx-auto mb-10 drop-shadow-md">
            Cloud infrastructure management and automation. Simplifying hyperscale deployments for modern enterprises.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="https://github.com/hyperscalerowl" className="bg-primary text-white px-8 py-4 rounded-lg font-bold hover:bg-blue-600 transition-colors shadow-lg">
              View on GitHub
            </Link>
