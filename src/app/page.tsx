    ...
    <div>
      <section className="hero">
        <div className="container">
          <h1 className="hero-title">Hyperscaler Owl</h1>
          <p className="hero-subtitle">
            Cloud infrastructure management and automation.
          </p>
          <div className="hero-actions">
            <Link href="https://github.com/hyperscalerowl" className="btn btn-primary">
              View on GitHub
            </Link>
          </div>
        </div>
          ...
          <div className="grid">
            <div className="card">
              ...
              <p className="card-desc">
                Foundational tools and libraries that power the hyperscalerowl ecosystem.
              </p>
            </div>
            <div className="card">
